...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full space-y-8 text-gray-400 md:w-1/3">
        <p
          className={`transform transition-opacity duration-1000 ease-in-out ${
            mounted
              ? "text-3xl font-semibold text-gray-200 delay-100"
              : "opacity-0"
          }`}
        >
          Zuunbileg.B
        ...
        <p
          className={
            mounted
              ? "translate-y-0 transform transition-all delay-200 duration-1000 ease-in-out"
              : "translate-y-8 opacity-0"
          }
        >
          Working at{" "}
        ...
        <p
          className={
            mounted
              ? "translate-y-0 transform transition-all delay-500 duration-500 ease-in-out"
              : "translate-y-8 opacity-0"
          }
        >
          ...
          <Link href="/projects" className="font-semibold text-white underline">
            {` here `}
          </Link>
        ...
        <p
          className={
            mounted
              ? "translate-y-0 transform transition-all delay-500 duration-1000 ease-in-out"
              : "translate-y-8 opacity-0"
          }
        >
        ...
        <div className="flex justify-center">
          <div className="h-px w-20 rounded-full bg-white bg-opacity-30"></div>
        </div>
        <div
          className={`space-y-2 ${
            mounted
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            {socials.map((social) => (
              <Link
                className="flex transform items-center gap-2 text-white transition-all duration-1000 hover:text-gray-200"
                key={social.title}
                href={social.link}
              >
                <svg
